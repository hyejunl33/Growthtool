    ...
    <main className="auth-shell">
      <section className="auth-card onboarding-card">
        ...
        <form onSubmit={submit}>
          <TextField label="브랜드명"><TextFieldInput value={name} onChange={(event) => setName(event.target.value)} required maxLength={80} placeholder="예: 모닝듀" /></TextField>
          <label className="seed-label">주요 카테고리<input value="뷰티" readOnly aria-readonly="true" /></label>
